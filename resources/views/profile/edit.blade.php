                            ...
                            <div class="card-body box-profile">
                                <div class="text-center">
                                    <img class="profile-user-img img-fluid img-circle"
                                        src="{{ asset(Auth::user()->foto ? 'storage/' . Auth::user()->foto : 'storage/photo_profil/default.jpg') }}"
                                ...
                                <p class="text-muted text-center">
                                    {{ !empty(Auth::user()->nim) ? 'NIM:' . Auth::user()->nim : 'NIM:' }}</p>
                                ...
                                <div class="tab-content">
                                    <div class="active tab-pane" id="activity">
                                        ...
                                        <div class="post">
                                            ...
                                            <div class="row mb-3">
                                                <div class="col-sm-6">
                                                    <img class="img-fluid" src="{{ asset('admin') }}/dist/img/photo1.png"
                                                        alt="Photo">
                                                </div>
                                                <!-- /.col -->
                                                <div class="col-sm-6">
