                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-primary">
                            ...
                            <!-- /.card-header -->
                            <!-- form start -->
                            <form action="{{ route('landingpage.update', $item->id) }}" method="POST"
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group dropdown">
                                        ...
                                        <input type="text" class="form-control" id="section" name="judul"
                                            placeholder="Judul" name="judul" value="{{ $item->judul }}">
                                    </div>
                                    <div class="form-group dropdown">
                                        <label for="content">Deskripsi</label>
                                        <input type="text" class="form-control" id="section"
                                            placeholder="Deskripsi here.." name="content" value="{{ $item->content }}">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    @if ($item && $item->foto)
                                        <div class="form-group">
                                            <img src="{{ asset('storage/' . $item->foto) }}" alt="test" width="300"
