...
<script src="{{ asset('landingpages') }}/assets/vendor/purecounter/purecounter_vanilla.js"></script>
<script src="{{ asset('landingpages') }}/assets/vendor/imagesloaded/imagesloaded.pkgd.min.js"></script>
