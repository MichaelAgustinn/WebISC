    ...
    <div class="container">
        <div class="row gy-4">
            <div class="col-lg-4" data-aos="fade-up" data-aos-delay="100">
                <div class="card">
                    <img src="{{ asset('landingpage') }}/assets/img/values-1.png" class="img-fluid" alt="">
            ...
            <div class="col-lg-4" data-aos="fade-up" data-aos-delay="200">
                <div class="card">
                    <img src="{{ asset('landingpage') }}/assets/img/values-2.png" class="img-fluid" alt="">
            ...
            <div class="col-lg-4" data-aos="fade-up" data-aos-delay="300">
                <div class="card">
                    <img src="{{ asset('landingpage') }}/assets/img/values-3.png" class="img-fluid" alt="">
